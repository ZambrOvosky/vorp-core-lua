Translation = {
	...
	Portugues_BR = {
		...
		MessageOfSystem = {
			...
			message3           = "Você precisa esperar até poder renascer",
			message4           = "ID do Jogador ",
			message5           = "você foi desmaiado, de acordo com a regra você deve esquecer os últimos 30 minutos",
			message6           = "Renascer!!!",
			permanentlyBan     = "Você está banido permanentemente!"
		},
		SuggestChat     = {
	...
	German       = {
		...
		MessageOfSystem = {
			...
			TimeZone           = " CET",     -- Set your timezoneDropReasonBanned   = "Du wurdest vom Server gebannt bis zum folgenden Zeitpunkt: ",
