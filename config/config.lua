...
Config = {
	...
	ReportCrashes          = false, -- Reports crashes to https://monitor.gtp-dev.com login in here to create your API KEY , by doing this you will help the community to improve the server stability and fix crashes faster
	...
	-----------------------------------------------------
	PrintPlayerInfoOnLeave = true,   -- Logs player information in the server console when they leave.
	PrintPlayerInfoOnEnter = true,   -- Logs player information in the server console upon joining.
	...
	initMoney              = 30.0,      -- Initial money amount for new players.
	initRol                = 0.0,       -- Initial role-play currency amount for new players.
	initInvCapacity        = 40.0,      -- Initial number of character inventory weight for new players. for old characters you must change in the database if you dont ave a new server
	...
	maxHealth              = 2,         -- Maximum health for players. 10 is full, 0 is empty.
	maxStamina             = 5,         -- Maximum stamina for players. 10 is full, 0 is empty.
	...
	savePlayersTimer       = 2,         -- Interval in minutes for automatically saving all players to the database.
	...
	name                   = 'ELDORADO HOOK',                                                                           -- Name displayed in webhook embeds.
	logo                   = '',                                                                                        -- Logo URL for webhook embeds.
	footerLogo             = '',                                                                                        -- Footer logo URL for webhook embeds.
	Avatar                 = 'https://media.discordapp.net/attachments/1168742987245830225/1181387831080386570/96x96.png', -- Avatar URL for webhook embeds.
	...
	HealthRecharge        = { enable = false, multiplier = 0.0 }, -- Auto-recharge for health, with a multiplier for speed.
	StaminaRecharge       = { enable = true, multiplier = 0.1 }, -- Auto-recharge for stamina, with a multiplier for speed.
	RespawnTime           = 900,                               -- Time in seconds before a player can respawn.
	...
	TimeZoneDifference    = -3,               -- Time difference from UTC, used in the banning system.
	...
	--===========================================
	appid                 = 1148323533395599420, -- Discord Application ID. Replace this with your own application's ID.
	biglogo               = 'eldorado',       -- Name of the image asset to use for the large icon in the rich presence.
	biglogodesc           = 'ELDORADO ROLEPLAY', -- Description displayed when hovering over the large icon.
	smalllogo             = 'redm',           -- Name of the image asset for the small icon in the rich presence. This is optional.
	smalllogodesc         = 'RedM',           -- Description displayed when hovering over the small icon.
	richpresencebutton    = 'Junte-se a nós!', -- Text displayed on the rich presence button.
	...
	Buttons               = {                 -- Configuration for buttons shown in the Discord rich presence.
		{
			...
			url = 'https://discord.gg/EldoradoRP',
